                ...
                <Grid container spacing={4} justifyContent="center" sx={{ marginTop: 4 }}>
                    <Grid item xs={12} sm={6} md={4}>
                        <Card sx={{ padding: 3, textAlign: 'center' }}>
                            <PublicIcon sx={{ fontSize: 60, color: '#1976d2', marginBottom: 2 }} />
                    ...
                    <Grid item xs={12} sm={6} md={4}>
                        <Card sx={{ padding: 3, textAlign: 'center' }}>
                            <GroupIcon sx={{ fontSize: 60, color: '#1976d2', marginBottom: 2 }} />
                            <Typography variant="h6" component="p">
                                8,000+ Employees
                            </Typography>
                            <Link href="#" underline="hover">
                    ...
                    <Grid item xs={12} sm={6} md={4}>
                        <Card sx={{ padding: 3, textAlign: 'center' }}>
                            <PeopleAltIcon sx={{ fontSize: 60, color: '#1976d2', marginBottom: 2 }} />
                            <Typography variant="h6" component="p">
                                228,000+ Customers
                            </Typography>
                            <Link href="#" underline="hover">
